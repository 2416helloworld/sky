package com.lk.knowpost.listener;

import com.fasterxml.jackson.core.type.TypeReference;
import com.lk.counter.event.CounterEvent;
import com.github.benmanes.caffeine.cache.Cache;
import com.lk.knowpost.api.dto.FeedItemResponse;
...
public class FeedCacheInvalidationListener {
    ...
    private final com.lk.knowpost.mapper.KnowPostMapper knowPostMapper;

    public FeedCacheInvalidationListener(@Qualifier("feedPublicCache") Cache<String, FeedPageResponse> feedPublicCache,
                                         StringRedisTemplate redis,
                                         ObjectMapper objectMapper,
                                         com.lk.counter.service.UserCounterService userCounterService,
                                         com.lk.knowpost.mapper.KnowPostMapper knowPostMapper) {
